...
from node2vecalgo.walker import Walker

class Node2vec(object):
    def __init__(self, graph, path_length, num_paths, dim, p, q, **kwargs):
        kwargs["workers"] = kwargs.get("workers", 1)
        kwargs["hs"] = 1
        self.graph = graph
        self.walker = Walker(graph, p=p, q=q, workers=kwargs["workers"])
